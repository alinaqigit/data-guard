...
export default function ScannerPage() {
  ...
  const handleStartScan = async () => {
    ...
    setIsScanning(true);
    try {
      await runScan(scanType, "All Files", scanPath);
      setToast({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div
          className="lg:col-span-2 border rounded-2xl p-4 md:p-5 shadow-lg transition-all duration-300"
          style={{
            background:
        ...
        <div
          className="border rounded-2xl p-4 md:p-5 shadow-lg transition-all duration-300 flex flex-col justify-center"
          style={{
            background:
              "linear-gradient(135deg, #020617 0%, #000000 100%)",
            borderColor: "rgba(51, 65, 85, 0.3)",
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-indigo-400 font-mono font-bold text-sm tracking-tighter">
                  {confidence}%
                </span>
              </div>
      ...
      <div
        className="border rounded-2xl p-4 md:p-5 shadow-lg transition-all duration-300"
        style={{
          background:
            "linear-gradient(135deg, #020617 0%, #000000 100%)",
          borderColor: "rgba(51, 65, 85, 0.3)",
